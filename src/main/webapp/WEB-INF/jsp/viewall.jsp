...
<c:forEach items="${foodproductsList}" var="foodproducts">
	...
	<div class="pricetext"></div><a href="#">
        ...
        <div class="pull-right"> <a href="edit/${foodproducts.productId}" class="btn btn-danger btn-xs" role="button">
        Edit
          <span class="glyphicon glyphicon-eye-open"></span>
           
        </a>
        </div>
        <div class="pull-right"> <a href="view/${foodproducts.productId }" class="btn btn-danger btn-xs" role="button">
        view
          <span class="glyphicon glyphicon-eye-open"></span>
